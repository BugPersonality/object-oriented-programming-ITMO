...
try backupManager.createBackUp(id: firstBackUpId, filesNames: "SwiftFunc20.txt", "SwiftFunc.txt")

try backupManager.createRestorePoint(id: firstBackUpId, typeOfPoint: .full, typeOfStorage: .separateStorage, filesNames: nil)

printLineIntoFile(filePath: "~/Swift/BackUpOOP/BackUpOOP/Files/SwiftFunc.txt")
try backupManager.createRestorePoint(id: firstBackUpId, typeOfPoint: .incremental, typeOfStorage: .separateStorage, filesNames: nil)
...
// f     i    f    i    f    i    i
try backupManager.cleanPoints(id: firstBackUpId, cleaner: PointCleaner(cleaningType: .sizeOfPoint(maxSizeOfAllPointInBytes: 36300)))
backupManager.printBackUp(id: firstBackUpId)
